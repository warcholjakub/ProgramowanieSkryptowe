...
class WorldMap(IWorldMap, IMoveValidator):
    ...
    def place(self, animal: Animal) -> None:
        if self.canMoveTo(animal.position): self.animals[animal.position] = animal
        else: raise PositionAlreadyOccupiedError(animal.position)
